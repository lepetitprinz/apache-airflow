...
def _get_message() -> str:
    return "Message from forex_data_pipeline"
...
with DAG(
    ...
    # Check the availability of forex rates
    is_forex_rates_available = HttpSensor(
        ...
        timeout=20          # Time, in seconds before the task times out and fails.
    )

    # Check the availability of file having currencies to watch
